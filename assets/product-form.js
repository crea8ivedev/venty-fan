  ...
  customElements.define(
    ...
    class ProductForm extends HTMLElement {
      ...
      onSubmitHandler(evt) {
        ...
        // Optimized: Direct cart addition for faster performance
        // Removed sequential cart checks and upsell logic that cause delays
          ...
          .then((response) => {
            ...
            if (quickAddModal) {
              document.body.addEventListener(
                ...
                () => {
                  setTimeout(() => {
                    // COMMENTED OUT: Using third-party cart drawer app instead of native cart drawer
