  ...
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      handleOptionValueChange({
        ...
        try {
          // Log the option input name (if available) and currently selected option values
          if (target) {
            console.log(
              "[Variant Option Changed] name:",
              target.name || "(no name)",
              "values:",
      ...
      renderProductInfo({ requestUrl, targetId, callback }) {
        ...
        fetch(requestUrl, { signal: this.abortController.signal })
          ...
          .then(() => {
            // set focus to last clicked option value without scrolling
            ...
            if (targetElement) {
              ...
              // Restore scroll position as fallback for browsers that don't support preventScroll
        ...
        return (html) => {
          ...
          try {
            if (variant) {
              ...
              if (pseudo && variant) {
                pseudo.setAttribute("data-selected-variant-id", JSON.stringify(variant));
              }
            } else {
              console.log("[Selected Variant] none");
            }
          } catch (e) {}
